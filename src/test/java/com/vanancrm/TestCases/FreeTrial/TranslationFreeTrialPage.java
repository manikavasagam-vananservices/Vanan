 ...
 */
public class TranslationFreeTrialPage extends TestBase implements TranslationPrice  {
    ...
    private String[] srclanguages = {"English", "Japanese", "Afrikaans","Armenian"};
 ...
 //    private String UScountry = "United States";
   ...
   //    url="https://vananservices.com/Translation-Free-Trial.php";
     //   driver.get(url);
        ...
        System.out.println("\n======================================");
        System.out.println("\nScenario #1");
        if (url.contains("Free-Trial")){
            testScenario(fileTypes[0], srclanguages[3], tarlanguages[1],
                    true, false, tiers[1], channels[0],false);
            System.out.println("\n======================================");
            System.out.println("\nScenario #2");
            testScenario(fileTypes[1], srclanguages[2], tarlanguages[1],
                    true, false, 0, channels[2], false);
        }else{
            System.out.println("Free trail failed ");
        }
    ...
    private void raiseTicket(String fileType, String srcLang, String targetLang,
        ...
        if (fileType.equals(fileTypes[1])) {
            ...
            translation.clickPrivacyPolicy();
            translation.clickProceedPayment();
        } else if (srcLang.equals(srclanguages[3]) || srcLang.equals
                (srclanguages[3])) {
        ...
        else if(srcLang.equals(srclanguages[1]) || srcLang.equals(srclanguages[1])){
    ...
    private void checkTickets(Menus menus, String fileType, String srcLang, String targetLang,
        ...
        for (int i = 0; i < tickets.size(); i++) {
            ...
            if (tickets.get(i).contains(service) &&  tickets.get(i).contains(name)) {
