...
public class TranslationLevel11 extends TestBase {
    ...
    private static List<Double> discountPercent = new ArrayList<Double>();
    ...
    private double expediateCost = 0;
    ...
    private String expediateStatus = "";
    ...
    public void testStep() throws IOException {
        for (int i = 0; i < sourceLanguages.size(); i++) {
            ...
            System.out.print("TAT : " + tats.get(i));
            ...
            if (!processings.get(i).equalsIgnoreCase("Request")) {
                ...
                if (tats.get(i) == 0) {
                    expediateCost = 0;
                } else if (tats.get(i) == 1) {
                    expediateCost = totalUnitCost / 2;
                } else if (tats.get(i) == 2) {
                    expediateCost = totalUnitCost;
                } else if (tats.get(i) == 3) {
                    expediateCost = totalUnitCost + (totalUnitCost / 2);
                }
                if (sourceLanguages.get(i).equals("English")) {
                ...
                mailCost = 20;
                grandtotal = totalUnitCost + expediateCost + certificationCost + mailCost;
                ...
                expediateStatus = checkStatus(expediateCost, translation.getExpeditedCost(), "Expedited service cost");
                if (sourceLanguages.get(i).equals("English")) {
                ...
                cell.setCellValue(expediateCost);
                ...
                cell.setCellValue(expediateStatus);
                ...
                if (unitStatus.equals("Pass") && totalUnitStatus.equals("Pass") && grandtotalStatus.equals("Pass")
                        && transcationStatus.equals("Pass") && orderStatus.equals("Pass") && expediateStatus.contains("Pass")
                        && mailStatus.contains("Pass")) {
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/Translation/TranslationL11.xls");
