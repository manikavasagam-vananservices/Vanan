...
public class TranslationLevel4 extends TestBase {
    ...
    public void testStep() throws IOException {
        for (int i = 0; i < sourceLanguages.size(); i++) {
            ...
            if (!processings.get(i).equalsIgnoreCase("Request")) {
                ...
                grandtotal = totalUnitCost + additionalQCCost;
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/Translation/TranslationL4.xls");
