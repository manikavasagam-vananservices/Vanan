...
public class TranslationLevel7 extends TestBase {
    ...
    public void testStep() throws IOException {
        for (int i = 0; i < 2; i++) {
            ...
            if (!processings.get(i).equalsIgnoreCase("Request")) {
                ...
                grandtotal = totalUnitCost + mailCost;
                ...
                if (unitStatus.equals("Pass") && totalUnitStatus.equals("Pass") && grandtotalStatus.equals("Pass")
                        && transcationStatus.equals("Pass") && orderStatus.equals("Pass") && mailStatus.equals("Pass")) {
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/Translation/TranslationL7.xls");
