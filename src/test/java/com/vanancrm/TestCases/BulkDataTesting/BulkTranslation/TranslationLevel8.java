...
public class TranslationLevel8 extends TestBase {
    ...
    public void testStep() throws IOException {
        for (int i = 0; i < 2; i++) {
            ...
            if (!processings.get(i).equalsIgnoreCase("Request")) {
                ...
                grandtotal = totalUnitCost + certificationCost;
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/Translation/TranslationL8.xls");
