...
public class TranslationLevel10 extends TestBase {
    ...
    public void testStep() throws IOException {
        for (int i = 0; i < sourceLanguages.size(); i++) {
            ...
            if (!processings.get(i).equalsIgnoreCase("Request")) {
                ...
                additionalQCStatus = checkStatus(additionalQCCost, translation.getAdditionalQualityAmount(), "Expedited service cost");
                if (sourceLanguages.get(i).equals("English")) {
                ...
                if (unitStatus.equals("Pass") && totalUnitStatus.equals("Pass") && grandtotalStatus.equals("Pass")
                        && transcationStatus.equals("Pass") && orderStatus.equals("Pass") && additionalQCStatus.contains("Pass")
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/Translation/TranslationL10.xls");
