...
public class AllSiteCheckTranslationQuote extends TestBase implements TranslationPrice {
    ...
    private void raiseTicket(String fileType, String srcLang, String targetLang,
        ...
        if (!srcLang.equals(srclanguages[1])) {
            System.out.println("Additional page URL : " + currentUrl);
    ...
    public static void readTranslateData() throws IOException {
        ...
        file = new File("src/test/resources/TranslationAll.xls");
